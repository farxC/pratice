...
class Bike(object):
    ...
    def service(self, spent, sale_price=None, condition=None):
        """
        Service the bike and update attriutes
        """
        self.cost += spent
    ...
    def __str__(self):
        return f'{type(self).__name__}: sellling for ${self.sale_price}, cost: ${self.cost} ({self.condition.name.lower()})'
...
if __name__ == '__main__':
    ...
    print(Trike.get_test_bike()) # Static Method
    print(Trike.get_test_bike()) #Class Method