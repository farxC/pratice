...
class BasePage:
    ...
    def fill_text(self, locator: Tuple[By, str], txt: str) -> None:
        el: WebElement = self.wait.unitl(expected_conditions.element_to_be_clickable(locator))
        el.clear()
        self._highlight_element(el,"green")
        el.send_keys(txt)
    ...
    def _highlight_element(self, webelement: WebElement, color: str) -> None:
        ...
        new_style = f"background-collor: yellow;border:1px solid {color}{original_style}"
